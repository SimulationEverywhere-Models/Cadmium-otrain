...
int main(){
    ...
    const char * i_input_data_passenger = "../input_data/StationQueue_input_test_PassengerIn.txt";
    ...
    const char * i_input_data_station = "../input_data/StationQueue_input_test_StationNumberIn.txt";
    ...
    /****** Station Queue atomic model instantiation *******************/
	// variable "3" is passed to atomic model which corresponds to Carleton as the station location
    ...
    dynamic::modeling::Models submodels_TOP = {input_reader_passenger, input_reader_station, SQ_Carleton};
    dynamic::modeling::EICs eics_TOP = {};
    dynamic::modeling::EOCs eocs_TOP = {
        dynamic::translate::make_EOC<StationQueue_defs::PassengerOut,outp_passenger>("SQ_Carleton")
    };
    dynamic::modeling::ICs ics_TOP = {
        dynamic::translate::make_IC<iestream_input_defs<PassengerID_t>::out,StationQueue_defs::PassengerIn>("input_reader_passenger","SQ_Carleton"),
		dynamic::translate::make_IC<iestream_input_defs<StationNumber_t>::out,StationQueue_defs::StationNumberIn>("input_reader_station","SQ_Carleton")
	};
    shared_ptr<dynamic::modeling::coupled<TIME>> TOP;
    TOP = make_shared<dynamic::modeling::coupled<TIME>>("TOP", submodels_TOP, iports_TOP, oports_TOP, eics_TOP, eocs_TOP, ics_TOP);

    /*************** Loggers *******************/
    static ofstream out_messages("../simulation_results/ATOMIC_TEST_StationQueue_outputs.txt");
    struct oss_sink_messages{
        static ostream& sink(){          
            return out_messages;
        }
    };
    static ofstream out_state("../simulation_results/ATOMIC_TEST_StationQueue_state.txt");
